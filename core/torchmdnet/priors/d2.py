...
from core.torchmdnet.priors.base import BasePrior
from core.torchmdnet.models.utils import OptimizedDistance, scatter
import torch as pt
...
class D2(BasePrior):
    ...
    Examples
    --------
    >>> from core.torchmdnet.priors import D2
    >>> prior = D2(
