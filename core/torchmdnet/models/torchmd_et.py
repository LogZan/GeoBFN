...
from core.torchmdnet.models.utils import (
    NeighborEmbedding,
    CosineCutoff,
    OptimizedDistance,
    rbf_class_mapping,
...
from core.torchmdnet.utils import deprecated_class
...
class TorchMD_ET(nn.Module):
    ...
    def __init__(
        ...
        self.embedding = nn.Linear(self.max_z, hidden_channels, dtype=dtype)
    ...
    def forward_update_pos(
        ...
        for attn in self.attention_layers:
            ...
            pos = self.coord_model(x, pos, edge_index, coord_diff, edge_attr)
